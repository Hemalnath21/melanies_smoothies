...
st.write(
  """Choose the Fruits you want to customize in your smoothie
  """
)
...
my_ingredients_list = st.multiselect(
    'Choose upto five Ingredients:',
     my_dataframe,
     max_selections=5  
)
if my_ingredients_list:
    ingredients_string = ''
    for fruit_chosen in my_ingredients_list:
